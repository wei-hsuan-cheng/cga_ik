...
inner_e1e2 = e1 | e2
inner_nino = ni | no
print(f"\ninner product of e1 and e1 = {inner_e1e2}")
print(f"\ninner product of e1 and e2 = {inner_e1e1}")
...
geo_e1e2 = e1 * e2
geo_nino = ni * no
print(f"\ngeometric product of e1 and e1 = {geo_e1e2}")
print(f"\ngeometric product of e1 and e2 = {geo_e1e1}")
