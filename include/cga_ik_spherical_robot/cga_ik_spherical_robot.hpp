...
CGA constructSphere(float r_s, const CGA &rc, int grade)
{
...
CGA computeEndPlateCornerOffset(float r_e, const CGA &s, float d, const CGA &e_p)
{
    ...
    Quaternionf target_quat_epl) 
{
    ...
    // Positions of the end-plate corners
    CGA offset_rot_cen_epl_0 = computeEndPlateCornerOffset(r_e, s_0, d, e_principal);
