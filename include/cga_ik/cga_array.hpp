...
// This code is originally adapted from https://github.com/enkimute/ganja.js/blob/master/codegen/cpp/cga.cpp
...
// Basis names (useful for debugging/logging)
...
class CGA {
  public:
    CGA ()  { std::fill( mvec, mvec + sizeof( mvec )/4, 0.0f ); }
    CGA (float f, int idx=0) { std::fill( mvec, mvec + sizeof( mvec )/4, 0.0f ); mvec[idx] = f; }
