...
'''
This code is originally adapted from https://github.com/enkimute/ganja.js/blob/master/codegen/python/cga.py
Some of the syntax used the "magic method" in python: https://rszalski.github.io/magicmethods/

CAUTION: 
1) Only accepts list, rather than ndarray! Make sure to use .tolist() to transfer into list
2) Only accepts float rather than np.float64! Make sure to use float() to transfer into float
'''
...
class CGA:
    ...
    def __invert__(a): # reverse (the "~" operator)
        """CGA.Reverse
    ...
    def __mul__(a,b): # geometric product (the "*" operator)
        """CGA.Mul
    ...
    def __xor__(a,b): # wedge or outer product (the "^" operator)
        res = a.mvec.copy()
        res[0]=b[0]*a[0]
    ...
    def __and__(a,b): # regressive product (the "&" operator)
        res = a.mvec.copy()
        res[31]=1*(a[31]*b[31])
    ...
    def __or__(a,b): # inner product (the "|" operator)
        res = a.mvec.copy()
        res[0]=b[0]*a[0]+b[1]*a[1]+b[2]*a[2]+b[3]*a[3]+b[4]*a[4]-b[5]*a[5]-b[6]*a[6]-b[7]*a[7]-b[8]*a[8]+b[9]*a[9]-b[10]*a[10]-b[11]*a[11]+b[12]*a[12]-b[13]*a[13]+b[14]*a[14]+b[15]*a[15]-b[16]*a[16]-b[17]*a[17]+b[18]*a[18]-b[19]*a[19]+b[20]*a[20]+b[21]*a[21]-b[22]*a[22]+b[23]*a[23]+b[24]*a[24]+b[25]*a[25]+b[26]*a[26]-b[27]*a[27]-b[28]*a[28]-b[29]*a[29]-b[30]*a[30]-b[31]*a[31]
        res[1]=b[1]*a[0]+b[0]*a[1]-b[6]*a[2]-b[7]*a[3]-b[8]*a[4]+b[9]*a[5]+b[2]*a[6]+b[3]*a[7]+b[4]*a[8]-b[5]*a[9]-b[16]*a[10]-b[17]*a[11]+b[18]*a[12]-b[19]*a[13]+b[20]*a[14]+b[21]*a[15]-b[10]*a[16]-b[11]*a[17]+b[12]*a[18]-b[13]*a[19]+b[14]*a[20]+b[15]*a[21]+b[26]*a[22]-b[27]*a[23]-b[28]*a[24]-b[29]*a[25]-b[22]*a[26]+b[23]*a[27]+b[24]*a[28]+b[25]*a[29]-b[31]*a[30]-b[30]*a[31]
        res[2]=b[2]*a[0]+b[6]*a[1]+b[0]*a[2]-b[10]*a[3]-b[11]*a[4]+b[12]*a[5]-b[1]*a[6]+b[16]*a[7]+b[17]*a[8]-b[18]*a[9]+b[3]*a[10]+b[4]*a[11]-b[5]*a[12]-b[22]*a[13]+b[23]*a[14]+b[24]*a[15]+b[7]*a[16]+b[8]*a[17]-b[9]*a[18]-b[26]*a[19]+b[27]*a[20]+b[28]*a[21]-b[13]*a[22]+b[14]*a[23]+b[15]*a[24]-b[30]*a[25]+b[19]*a[26]-b[20]*a[27]-b[21]*a[28]+b[31]*a[29]+b[25]*a[30]+b[29]*a[31]
    ...
    def __add__(a,b): # addition (the "+" operator)
        """CGA.Add
    ...
    def __sub__(a,b): # subtraction (the "-" operator)
        """CGA.Sub
    ...
    def smul(a,b): # left multiply a scalar
        res = a.mvec.copy()
        res[0] = a*b[0]
        res[1] = a*b[1]
        res[2] = a*b[2]
    ...
    def muls(a,b): # right multiply a scalar
        res = a.mvec.copy()
        res[0] = a[0]*b
        res[1] = a[1]*b
        res[2] = a[2]*b
    ...
    def ssub(a,b): # scalar subtraction
        res = a.mvec.copy()
        res[0] = a-b[0]
        res[1] = -b[1]
        res[2] = -b[2]
    ...
    def subs(a,b): # subtraction scalar
        res = a.mvec.copy()
        res[0] = a[0]-b
        res[1] = a[1]
        res[2] = a[2]
